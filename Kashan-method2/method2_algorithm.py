...
G=nx.Graph()
sub_G=nx.Graph()
reader_points =pd.read_excel(r'E:\learning_pymc3\Thesis_Code\Prim_Algorithm\kashan\kashan_points.xlsx')
reader_cost =pd.read_excel(r'E:\learning_pymc3\Thesis_Code\Prim_Algorithm\kashan\kashan_cost.xlsx')
